...
public class EnhancedListView extends ListView {
    ...
    /**
     * The callback interface used by {@link #setDismissCallback(com.tmnt.queuer.views.EnhancedListView.OnDismissCallback)}
    ...
    public interface OnDismissCallback {
         ...
         *
         * @param listView The {@link com.tmnt.queuer.views.EnhancedListView} the item has been deleted from.
     ...
     * {@link com.tmnt.queuer.views.EnhancedListView.OnDismissCallback#onDismiss(com.tmnt.queuer.views.EnhancedListView, int)}
     * to let the user undo the deletion you've done with your {@link com.tmnt.queuer.views.EnhancedListView.OnDismissCallback}.
    ...
    public abstract static class Undoable {
         ...
         * {@link com.tmnt.queuer.views.EnhancedListView.OnDismissCallback#onDismiss(com.tmnt.queuer.views.EnhancedListView, int)} and reinsert
     ...
     * {@link de.timroes.android.listview.EnhancedListView.OnDismissCallback#onDismiss(com.tmnt.queuer.views.EnhancedListView, int)}
     ...
     * from {@link de.timroes.android.listview.EnhancedListView.OnDismissCallback#onDismiss(com.tmnt.queuer.views.EnhancedListView, int)}.
     ...
     * @throws IllegalStateException when you haven't passed an {@link com.tmnt.queuer.views.EnhancedListView.OnDismissCallback}
     *      to {@link #setDismissCallback(com.tmnt.queuer.views.EnhancedListView.OnDismissCallback)} before calling this
     *      method.
     */
     ...
     * By default this is set to {@link com.tmnt.queuer.views.EnhancedListView.SwipeDirection#BOTH} so that an item
     ...
     * {@link com.tmnt.queuer.views.EnhancedListView.Undoable#discard()} might not be called for several items, what might
     ...
     * @throws IllegalStateException when this method is called before an {@link com.tmnt.queuer.views.EnhancedListView.OnDismissCallback}
